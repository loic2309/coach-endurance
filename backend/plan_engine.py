...
def _build_week() -> dict[int, list[Session]]:
    return {
        ...
        1: [Session("burn", "strength", "burn", "Le Mix — Burn", 60,
                    "Cours Burn : force/puissance full-body. Sers-t'en comme base force triathlon.", "Z4")],
        ...
        3: [Session("run-thr", "run", "threshold", "Course seuil (tapis)", 55,
                    "Échauff. 15' + 4×6' au seuil (allure ~semi), récup 90\". Qualité course de l'hiver.", "Z4")],
        ...
        5: [Session("run-long", "run", "long", "Sortie longue course", 95,
                    "Z2 dehors si possible. Maintien du volume aérobie course malgré l'hiver.", "Z2")],
